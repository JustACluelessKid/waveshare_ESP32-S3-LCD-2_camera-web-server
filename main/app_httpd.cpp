...
/* Provide wrapper symbols for esp_log when diagnostics expects them.
 * Some components reference __wrap_esp_log_write/__wrap_esp_log_writev.
 * If those wrappers are not provided elsewhere, provide lightweight
 * forwarding implementations to esp_log_writev to satisfy the linker.
 */
#ifdef __cplusplus
extern "C" {
#endif
...
// LED FLASH setup (use board_config.h to define LED_GPIO_NUM if present)
